              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div>
                  ...
                  <SliderInput
                    ...
                    value={inputs.hourlyWageOperatorCurrent}
                    onChange={(value) => handleInputChange('hourlyWageOperatorCurrent', value)}
                    min={0}
                    max={60}
                    step={0.01}
                    decimals={2}
                ...
                <div>
                  ...
                  <SliderInput
                    ...
                    onChange={(value) => handleInputChange('hourlyWageOperatorPost', value)}
                    min={0}
                    max={60}
                    step={0.01}
                    decimals={2}
